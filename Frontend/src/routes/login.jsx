   ...
   return (
      <div className="flex h-screen mx-auto justify-center pt-10 bg-gray-100">
         <div className="h-fit flex flex-col gap-3 px-10 py-10 bg-white rounded-2xl shadow-2xl w-2/6">
            ...
            <div>
               <h4 className="text-4xl font-semibold">Hey,</h4>
               <h4 className="text-4xl font-semibold">Welcome Back</h4>
               <h4 className="text-xs mt-2">Please login to continue</h4>
            </div>
            <div className="flex flex-col gap-5">
               ...
               <button className="bg-indigo-600 text-amber-50 text-2xl mt-2 px-10 py-3 rounded-full transition-all ease-in-out cursor-pointer hover:scale-105">Login</button>
            </div>
