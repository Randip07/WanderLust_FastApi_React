        ...
        <h1 className="text-3xl tracking-wider">List Your Home</h1>
         <div className="px-10 py-10 flex justify-center">
            <div className="bg-white px-10 py-10 flex flex-col gap-3 w-3/4 rounded-2xl shadow-2xl">
              ...
              <TextField id="outlined-basic" label="Home Name" variant="outlined" size="small"/>
              <h4>Enter your home description</h4>
              <TextField id="outlined-basic" multiline label="Home Description" variant="outlined" size="small" className="w-full"/>
              <h4>Enter your home location</h4>
              <TextField id="outlined-basic" label="Home Location" variant="outlined" size="small" className="w-full"/>
              <h4>Enter your home Price</h4>
              <TextField id="outlined-basic" label="Price per night" variant="outlined" size="small" className="w-full" type="number"/>
